...
class Footer {
    ...
    public function register() {
	    ...
	    $slug = !empty( $opt['footer_slug']) ? strtolower( str_replace( ' ', '', $opt['footer_slug']) ) : $this->slug;
        $labels = array(
            'name'                  => $this->name,
        ...
        $args = array(
            ...
            'hierarchical'          => true,
            'menu_position'         => 25   ,
            'supports'              => array( 'title', 'editor', 'excerpt', 'author', 'thumbnail', 'elementor'),
            'yarpp_support'         => true,
            'menu_icon'             => $this->icon
        );

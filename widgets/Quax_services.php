 ...
 * @since 1.7.0
 */
class Quax_Services extends Widget_Base
{

    public function get_name()
    {
        return 'quax_services';
    }

    public function get_title()
    {
        return __('Quax Services', 'quax-core');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            'style',
            [
                'label' => __('services Style', 'quax-core'),
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .quax_services_title' => 'color: {{VALUE}};',
                ],
            ]
        );
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .quax_services_title',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .services_content p' => 'color: {{VALUE}};',
                ],
                'separator' => 'before'
            ]
        );
        $this->add_group_control(
            ...
            [
                ...
                'label' => __('Typography', 'quax-core'),
                'selector' => '{{WRAPPER}} .services_content p',
            ]
        );
        $this->end_controls_section();
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .quax_services_item a.read_btn, {{WRAPPER}} .quax_services_item span.quax_post_category i, {{WRAPPER}} .quax_services_item .quax_post_meta i' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .quax_services_item a.read_btn:hover, {{WRAPPER}} .quax_services_item span.quax_post_category:hover i, {{WRAPPER}} .quax_services_item .quax_post_meta:hover i' => 'color: {{VALUE}};',
                ]
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .h_services_area' => 'background: {{VALUE}}',
                ]
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .h_services_area' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
    ...
    protected function render()
    {
        ...
        $services_post = new WP_Query($arrs);
...
?>
        <div class="row justify-content-center quax_services_post">
            <?php
                    ...
                    <div class="quax_services_item">
                        ...
                        <div class="services_content">
                            <a href="<?php the_permalink() ?>">
                                <?php echo '<' . $title_tag . ' class="quax_services_title">' . quax_get_limit_char(get_the_title(), $settings['limit_title_char'], '') . '</' . $title_tag . '>'; ?>
                            </a>
